...
export namespace http {
	string post_form(string url, string body, string content_type = "application/x-www-form-urlencoded") {
		...
		if (!WinHttpSendRequest(rh.hRequest, headers.c_str(), static_cast<DWORD>(headers.size()),
